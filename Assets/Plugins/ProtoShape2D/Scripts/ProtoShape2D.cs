...
public class ProtoShape2D:MonoBehaviour{
	...
	//This will contain all the points including the ones generated for smoothing the curves
	//It's public so the editor script could draw the outline, move the pivot and place the marker for new points
	...
	//TODO: use these. add inpector options, set these
